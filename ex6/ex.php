			...
			<fieldset>
				...
				<table style="margin:auto">
					...
					<tr>
						...
						<td>
							<input style="width:16px" type="radio" name="sex[male]" id="M">
							<label style="width:184px" for="sex[Мужчина]">Мужчина</label>
							<br>	
							<input style="width:16px" type="radio" name="sex[female]" id="F">
							<label style="width:184px" for="sex[Женщишна]">Женщина</label>
						</td>
					</tr>
					<tr>
